...
SWEP.PrintName = "Большая пачка скитлс"
SWEP.Author = "Нннн"
SWEP.Purpose = "Большая пачка бренда жевательных конфет с фруктовым вкусом компании Mars Inc."
...
SWEP.ViewModel = "models/davorest/russianpropspart2/drazhe_big.mdl" -- Модель сухариков
SWEP.WorldModel = "models/davorest/russianpropspart2/drazhe_big.mdl"
