...
SWEP.PrintName 				= "Самодельный Дробавик"
SWEP.Author 				= "TheBogler"
SWEP.Instructions			= "Кустарное оружие использующее калибр 12/70"
...
SWEP.ViewModel                = "models/weapons/darky_m/rust/w_sawnoffshotgun.mdl"
