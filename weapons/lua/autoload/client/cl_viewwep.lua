...
local wepsData_viewwep = {
    ["weapon_glock18"] = {vec = {3.85, 10, 1.45}, ang = {5, 10, 0}},
    ...
    ["weapon_deagle"] = {vec = {2.8, -7.5, 1}, ang = {-10, 0, 0}},
    ["weapon_craft_gun"] = {vec = {2.5, -10, 0.05}, ang = {0, 2, 0}},
    ["weapon_deagle_csgo"] = {vec = {2.7, -10, 0.4}, ang = {-10, 0, 0}},
    ["weapon_fiveseven"] = {vec = {2.5, -10, 0.1}, ang = {-10, 3, 0}},
    ["weapon_mp5"] = {vec = {4.17, -7, 0.79}, ang = {-5, 0, 0}},
    ["weapon_m3super"] = {vec = {3.66, -5, 0.65}, ang = {-5, 0, 0}},
    ["weapon_p220"] = {vec = {2.7, -10, 0.12}, ang = {-15, 2, 0}},
    ["weapon_hk_usp"] = {vec = {2.43, -10, 0.3}, ang = {-15, 5, 0}},
    ["weapon_hk_usps"] = {vec = {3.9, -10, 1.09}, ang = {0, 10, 0}},
    ...
    ["weapon_m14"] = {vec = {6, -4, 0.95}, ang = {25, 35, 15}},
...
CalcView = function(ply,vec,ang,fov,znear,zfar)
	...
	if wep and weps[wep:GetClass()] then
		...
		if weaponClass == "weapon_fiveseven_example" then
			--Vector(2.5,10,0.1)
			vecWep = hand.Pos + hand.Ang:Up() * 3.5 - hand.Ang:Forward() * 10 + hand.Ang:Right() * 0.05
			angWep = hand.Ang + Angle(-10,3,0)
		end
		--[[if RENDERSCENE then
			local wep = lply:GetActiveWeapon()
