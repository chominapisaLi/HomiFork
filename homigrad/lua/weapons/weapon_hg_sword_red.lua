...
SWEP.PrintName = "Меч Семьи Крэнбрук"
...
SWEP.ViewModel = "models/morrowind/silver/longsword/w_silver_longsword.mdl"
SWEP.WorldModel = "models/morrowind/silver/longsword/w_silver_longsword.mdl"
