...
SWEP.PrintName = "Скитлс"
SWEP.Author = "Нннн"
SWEP.Purpose = "Бренд жевательных конфет с фруктовым вкусом компании Mars Inc."
...
SWEP.ViewModel = "models/davorest/russianpropspart2/drazhe.mdl" -- Модель сухариков
SWEP.WorldModel = "models/davorest/russianpropspart2/drazhe.mdl"
