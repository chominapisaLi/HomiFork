...
cp.blue = {"Синие",Color(75,75,255),
    weapons = {"weapon_binokle","weapon_hg_flashbang","weapon_radio","weapon_hands","weapon_t","med_band_big","med_band_small","medkit","painkiller","weapon_handcuffs","weapon_taser"},
